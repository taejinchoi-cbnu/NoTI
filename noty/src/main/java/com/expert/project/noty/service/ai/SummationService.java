...
//        this.promptProperties = promptProperties;
    ...
    public SummationResponse processGeminiRequest(String userId, String savedFileName) {
        ...
        // 전체 프롬프트 생성
        String defaultPrompot = """
                [역할] 당신은 회의록 작성 전문가입니다.
                [맥락] 다음은 팀 회의 녹취록입니다.
                [지시] 이 회의의 핵심 내용을 요약해 주세요.
                [목적] 팀원이 결과를 빠르게 공유하고 다음 단계를 준비할 수 있도록 합니다.
                [형식] * 주요 논의 주제 * 결정된 사항(있다면) * 주요 액션 아이템(담당자 포함) * 기타 주요 의견 * 시간별 순서 * 약속 시간(있다면)
                [길이] 회의 길이에 비례
                [포함/제외] 상세 설명 대신 핵심 아이디어와 결론 중심, 잡담/주제 이탈 내용 제외
                [스타일] 명확하고 간결한 비즈니스 스타일로 작성, 마크업 언어를 사용하여 깔끔하게 보여주기. 마크다운 문서에서 제목이나 소제목은 그대로 두고, 주제 아래에 나열된 리스트 항목들(* 항목)만 • 기호로 바꿔주세요. 줄바꿈은 <br />로 바꿔주세요
                [내용]""";
